...
- (void)createNavigation
{
    ...
    navTitle.frame = CGRectMake(SCREEN_WIDTH/2-70,navBgImageView.center.y - 30, 140, 40);
...
//    /* 创建WJSegmentMenuVc */
    ...
    UIStoryboard *storyBoard=[UIStoryboard storyboardWithName:@"FilterVCSB" bundle:nil];
    
     FilterViewController  *filterVC =[storyBoard instantiateInitialViewController];

//    filterVC.carLevel = 8;
 
    canBuyVC.view.backgroundColor = [UIColor clearColor];
    
    NSArray *vcArr = @[canBuyVC,canBuyVC2,canBuyVC3,canBuyVC4,canBuyVC5,canBuyVC6,canBuyVC7,filterVC];
    //对应
