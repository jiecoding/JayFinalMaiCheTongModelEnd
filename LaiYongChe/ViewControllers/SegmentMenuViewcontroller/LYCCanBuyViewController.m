...
//        _collectionView = [[UICollectionView alloc]initWithFrame:self.view.bounds collectionViewLayout:flowLayout];
        _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 4, self.view.width, self.view.height) collectionViewLayout:flowLayout];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImageView *carImageView = [[UIImageView alloc]initWithFrame:CGRectMake(cell.width/2 - 60, 0,cell.width*0.7, cell.height*0.5)];
    ...
    UIImageView *iconImageV = [[UIImageView alloc] initWithFrame:CGRectMake(cell.width/2 - 10, cell.height/2-5 ,cell.width/5.66, cell.height/6.66)];
...
{
    if(IS_IPHONE_5){
        return UIEdgeInsetsMake(10,10,10,5);//分别为上、左、下、右
    }else{
